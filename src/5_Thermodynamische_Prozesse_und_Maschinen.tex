...
Die Realisierung thermodynamischer Maschinen baut auf zwei wesentlichen Prinzipien auf: Der Energieerhaltung (und allen damit verbundenen Gesetzen der Mechanik) und der Monotonie der Entropiezunahme ($\Delta S \geq 0$) in abgeschlossenen Systemen.
