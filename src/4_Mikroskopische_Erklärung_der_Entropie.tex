...
\begin{align*}
    ...
    \right. \:.
\end{align*}
$N$ ist wie gehabt die Gesamtzahl der Spins und wir nennen $2n$ den \textit{Spinüberschuss}. Der letztere bestimmt allein das makroskopische Gesamtmoment
\begin{align*}
    M=2n\cdot m.
\end{align*}
...
\subsection{Spinsysteme im thermischen Kontakt}
