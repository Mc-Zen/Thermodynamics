...
\begin{summary}
    ...
    Zuletzt beschreibt das Nernst-Postulat, der dritte Hauptsatz der Thermodynamik (Postulat~\ref{post:nernst}), einen Nullpunkt $S=0$ bei $T=0$, der aber nicht praktisch erreicht werden kann. 
