...
\begin{summary}
    ...
    Wir haben dann die Eulergleichung in Energie- und Entropiedarstellung kennengelernt:
    \begin{align*}
    ...
    Zuletzt wurde aus der Eulergleichung und dem bereits bekannten Differential der inneren Energie die sogenannte Gibbs-Duhem-Beziehung
    \begin{align*}
